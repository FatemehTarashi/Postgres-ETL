...
def process_song_file(cur, filepath):
    """
    this function using pandas
    first, read the information
    second insert them into database.
    Arguments:
        cur: cursor
        filepath: The path of song file (json)
    """
    # open song file
...
def process_log_file(cur, filepath):
    """
    this function using pandas and numpy
    first, read the information
    second insert them into database.
    Arguments:
        cur: cursor
        filepath: The path of log file (json)
    """
    # open log file
    df = pd.read_json(filepath,lines=True)
...
def process_data(cur, conn, filepath, func):
    """
    this function using pandas 
    first, read the data and process them.
    Arguments:
        cur: cursor
        conn: connection
        filepath: This path includes json files 
        func: process fanction name
    """
